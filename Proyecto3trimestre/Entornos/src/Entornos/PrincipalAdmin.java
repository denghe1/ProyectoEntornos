...
//JMenu lib = new JMenu("Libros");
	...
	JMenuItem Ltitulo = new JMenuItem("Consultar por titulPrincipalUsero");
...
public static void main(String[] ar) {
	PrincipalAdmin formulario1 = new PrincipalAdmin();
...
public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == Tdoc) {
			Documentales ddoc = new Documentales();
